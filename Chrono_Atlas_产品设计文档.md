...
Chrono Atlas 是一个覆盖公元前 50 万年至公元 2030 年的交互式历史知识平台。它将超过 10,000 条历史事件组织在 12 个类目、76 个国家/地区、10 个时代分期的多维数据体系中，通过 5 种视图模式、20+ 种交互功能和游戏化成就系统，让用户从"看数据"变成"感受历史"。

### 核心数据

| 维度 | 数值 |
|------|------|
| 时间跨度 | 公元前 50 万年 — 公元 2030 年 |
| 总事件数 | 10,700 条 |
