...
const REGION_PERSPECTIVES: Record<string, string> = {
  ...
  colombia: '哥伦比亚是魔幻现实主义的故乡——马尔克斯笔下的马孔多不是虚构，而是对拉美现实最精确的描写。黄金博物馆中数千件前哥伦布时期的金器证明：这片土地上的文明远比征服者想象的古老和精致。',
  cuba: '古巴是加勒比海上的矛盾之岛——革命的激情、朗姆酒的热烈、老爷车的怀旧和萨尔萨舞的奔放共存于90英里外就是美国的这片土地上。卡斯特罗的革命改变了整个冷战的格局。',
  chile: '智利是安第斯山脉与太平洋之间一条狭长的土地——聂鲁达的诗歌、阿连德的民主实验和皮诺切特的独裁共同构成了20世纪拉美最戏剧性的政治弧线。',
}
