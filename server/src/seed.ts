...
type Region =
  ...
  | 'vietnam' | 'thailand' | 'cambodia' | 'laos' | 'myanmar' | 'indonesia' | 'philippines' | 'malaysia' | 'singapore'
  | 'india' | 'pakistan' | 'bangladesh' | 'sri-lanka' | 'nepal' | 'bhutan'
  | 'kazakhstan' | 'iran' | 'iraq' | 'turkey' | 'israel' | 'lebanon' | 'jordan' | 'saudi-arabia' | 'syria' | 'uzbekistan' | 'afghanistan'
  | 'uk' | 'france' | 'germany' | 'italy' | 'spain' | 'portugal' | 'greece' | 'russia' | 'ukraine'
  | 'netherlands' | 'poland' | 'austria' | 'sweden' | 'finland' | 'switzerland' | 'belgium' | 'czech'
  | 'norway' | 'denmark' | 'ireland' | 'romania' | 'hungary' | 'serbia'
  | 'egypt' | 'ethiopia' | 'nigeria' | 'south-africa' | 'morocco' | 'algeria' | 'mali' | 'sudan' | 'ghana' | 'kenya' | 'tanzania'
  | 'usa' | 'mexico' | 'brazil' | 'argentina' | 'peru' | 'colombia' | 'venezuela' | 'bolivia' | 'canada' | 'chile' | 'cuba'
